...
@section('title', 'Créer une nouvelle bande dessinée')
@section('styles')
    ...
    <div class="container py-4">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Créer une nouvelle bande dessinée</li>
            </ol>
        </nav>
        ...
        <div class="form-container">
            <h1 class="mb-4">Créer une nouvelle bande dessinée</h1>

            <form action="{{ route('authordashboard.comics.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">Créer la bande dessinée</button>
                </div>
            </form>
        </div>
    </div>
